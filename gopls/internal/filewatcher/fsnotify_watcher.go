...
type fsnotifyWatcher struct {
	...
	// absolute path should be excluded from watching.
...
func NewFSNotifyWatcher(delay time.Duration, logger *slog.Logger, eventsHandler func([]protocol.FileEvent), errHandler func(error), opts ...Option) (Watcher, error) {
